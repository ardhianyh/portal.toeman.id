          		...
          		<div class="wrapper">
              	    <div class="side-bar">
                          <ul>
                              ...
                              <div class="menu">
                                  <li>
                                      <a href="#"><span class="glyphicon glyphicon-dashboard pull-right"></span>Dashboard </a>
                                  </li>
                                  <li>
                                      <a href="#" class="active"><span class="glyphicon glyphicon-user pull-right"></span>Karyawan</a>
                                  </li>
                                  <li>
                                      <a href="#"><span class="glyphicon glyphicon-list pull-right"></span> Product</a>
                                  </li>
                                  <li>
                                      <a href="#"><span class="glyphicon glyphicon glyphicon-lock pull-right"></span>Admin </a>
                                  </li>
                              </div>
                          </ul>
              	    </div>
              ...
              <div class="col-md-12">
                ...
                <div class="col-lg-10">
                  <div class="panel panel-success">
                    <div class="panel-heading">Tabel Data Karyawan <a href="<?php echo base_url()."index.php/karyawan"; ?>"><span class="glyphicon glyphicon-remove" style="float: right;"></span></a></div>
                    <div class="panel-body">
                      <form id="formKaryawan" class="form-horizontal" method="POST">
                        <div class="form-group">
                            <label class="control-label col-xs-2">NIK*</label>
                            <div class="col-xs-2">
                                <input type="number" id="nik" class="form-control" name="nik" required>
                            </div>
                        </div>
                        <div class="form-group  ">
